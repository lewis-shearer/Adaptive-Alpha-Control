...
\begin{itemize}[nosep]
    ...
    Section~3, but with $\alpha$ held constant for the whole run. We
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{../german/results/pareto_frontier.png}

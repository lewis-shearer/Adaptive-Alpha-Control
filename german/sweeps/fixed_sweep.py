"""
Fixed-Alpha sweep, W&B-Sweep-driven variant of fixed.py, for the German
Credit dataset.
...
wandb.init(group=f"FixedAlpha_{alpha:g}", tags=["german", "FixedAlpha_sweep"])

# rename the run so it matches fixed.py's naming convention regardless of
# which machine produced it
wandb.run.name = f"fixed_alpha{alpha:g}_german_gender_seed{SEED}"
